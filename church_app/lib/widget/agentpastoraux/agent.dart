...
class AgentPastoraux extends StatefulWidget {
  
  ValueNotifier<int> npage= ValueNotifier(0);
  AgentPastoraux({ Key? key,required this.npage }) : super(key: key);

  @override
  State<AgentPastoraux> createState() => _AgentPastorauxState();
}

class _AgentPastorauxState extends State<AgentPastoraux> {
  @override
            ...
            child: SingleChildScrollView(
              child:Column(
                ...
                children: [
                  ...
                  btnOption("Ajouter", 10),
                  btnOption("Liste du personnel", 11),
                ],
              ) ,
              )
          )
